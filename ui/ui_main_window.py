...
"")
        ...
        self.lbl_mat_sigma = QLabel(self.group_material)
        self.lbl_mat_sigma.setObjectName(u"lbl_mat_sigma")

        self.gridLayout_2.addWidget(self.lbl_mat_sigma, 0, 4, 1, 1)

        self.sb_mat_sigma = QLineEdit(self.group_material)
        self.sb_mat_sigma.setObjectName(u"sb_mat_sigma")

        self.gridLayout_2.addWidget(self.sb_mat_sigma, 0, 5, 1, 1)
        ...
        self.lbl_str_step = QLabel(self.group_stringers)
        self.lbl_str_step.setObjectName(u"lbl_str_step")

        self.gridLayout_4.addWidget(self.lbl_str_step, 0, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sb_d_small.setText(QCoreApplication.translate("MainWindow", u"1281.0", None))
        self.sb_height.setText(QCoreApplication.translate("MainWindow", u"1036.0", None))
        self.sb_d_large.setText(QCoreApplication.translate("MainWindow", u"1507.0", None))
        self.group_material.setTitle(QCoreApplication.translate("MainWindow", u"\u041c\u0430\u0442\u0435\u0440\u0438\u0430\u043b", None))
        self.txt_mat_name.setText(QCoreApplication.translate("MainWindow", u"Aluminium", None))
        ...
        self.sb_thick_step.setText(QCoreApplication.translate("MainWindow", u"0.1", None))
        ...
        self.lbl_str_step.setText(QCoreApplication.translate("MainWindow", u"\u0428\u0430\u0433:", None))
